...
def get_lstm_point_net_model(num_frame, l0_xyz, l0_points, batch_size, num_point, is_training, bn_decay, num_classes):
    ...
    net = tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(32, return_sequences=True, dropout=0.4, recurrent_dropout=0.4))(net, scope='lstm1', training=is_training)
    net = tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(32, dropout=0.4, recurrent_dropout=0.4))(net, scope='lstm2', training=is_training)

...
def get_model(point_cloud, is_training, num_classes, bn_decay=None):
    ...
    for frame_index in range(num_frame):
        ...
        if end_points['l2_xyz'] is None:
            ...
            end_points['l3_points'] = tf.expand_dims(l3_points, 1)
            ...
            end_points['l3_points'] = tf.concat([end_points['l3_points'], tf.expand_dims(l3_points, 1)], 1)
            end_points['l2_indices'] = tf.concat([end_points['l2_indices'], tf.expand_dims(l2_indices, 1)], 1)
        end_points['l3_points_{}'.format(frame_index)] = l3_points

...
def get_lstm_point_net_model(num_frame, l0_xyz, l0_points, batch_size, num_point, is_training, bn_decay):
    ...
    for frame_index in range(num_frame):
        ...
        l1_xyz, l1_points, l1_indices = pointnet_sa_module(point_net_input, l0_points, npoint=16, radius=2, nsample=4, mlp=[32,32,64], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='frame-layer1', use_nchw=True, reuse_weights=frame_index > 0)

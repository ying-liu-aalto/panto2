...
def get_model(point_cloud, is_training, num_classes, bn_decay=None):
    ...
    for frame_index in range(num_frame):
        ...
        l1_xyz, l1_points, l1_indices = pointnet_sa_module(point_net_input, l0_points, npoint=512, radius=0.8, nsample=32, mlp=[32,32,64], mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='frame-layer1', use_nchw=True, reuse_weights=frame_index > 0)
        ...
        l3_xyz, l3_points, l3_indices = pointnet_sa_module(l1_xyz, l1_points, npoint=None, radius=None, nsample=None, mlp=[64,64,256], mlp2=None, group_all=True, is_training=is_training, bn_decay=bn_decay, scope='frame-layer3', reuse_weights=frame_index > 0)
